                  ...
                  Stack(
                    children: [
                      ...
                      Container(
                        ...
                        //
                        // ),
                        margin: EdgeInsets.only(top: getPercentSize(height, 70),right: horizontalMargin,left: horizontalMargin),

                        
                        child: Card(
                          color: backgroundColor,
                          shape: RoundedRectangleBorder(
                            borderRadius:  BorderRadius.all(Radius.circular(getPercentSize(viewHeight, 8)))
                          ),
                          ...
                          child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                getCell(viewHeight, primaryColor,
                                    "Protein", "530"),
                                ...
                                getCell(viewHeight, Colors.orange,
                                    "Carbs", "250"),

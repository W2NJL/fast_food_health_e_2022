...
import 'package:fast_food_health_e_2022/ManageDiet.dart';
import 'package:fast_food_health_e_2022/NotificationPage.dart';
import 'package:fast_food_health_e_2022/TabBMI.dart';
...
class _TabSetting extends State<TabSetting> {
          ...
          child: ListView(
            ...
            children: [
              ...
              GestureDetector(
                ...
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => ManageDiet(),));
  ...
  Future<void> share() async {
    Share.share(S.of(context).appname, subject: S.of(context).appname);
  }

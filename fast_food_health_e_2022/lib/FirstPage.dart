...
import 'package:fast_food_health_e_2022/CreatePlanPage.dart';
...
class _FirstPage extends State<FirstPage> {
  ...
  List<String> hearAboutList = ["In social media ad","From a person I follow","From my friend","On TV",
    "On the radio","Other"];
          ...
          body: Stack(
            children: [
              Container(
                ...
                child:widgetList.length > 0? widgetList[_position]:Container(),
              ),
              Container(
            ...
            Expanded(
              child: ListView.separated(
                ...
                separatorBuilder: (context, index) {
                  return Container(color: subTextColor.withOpacity(0.1),
                    height: 0.5,
                      ...
                      child: Row(
                        children: [
                          ...
                          Icon(
                            ...
                            color: isSelect?primaryColor:subTextColor.withOpacity(0.1),
                  ...
                  return InkWell(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          Image.asset(
                            ConstantData.assetsPath + motivateList[index].image!,
                            height: getScreenPercentSize(context, 4),
                          ),
                          SizedBox(
                            width: margin,
  ...
  Widget heightWidget() {
    ...
    TextEditingController textEditingController = new TextEditingController(text: cm.toString());
    TextEditingController textEditingController1 = new TextEditingController(text: ft.toString());
    TextEditingController textEditingControllerInch = new TextEditingController(text: inch.toString());
                      ...
                      child: Row(
                        ...
                        children: [
                          IntrinsicWidth(
                            ...
                            child:    getTextField((isCm)?textEditingController:textEditingController1),
                          ),
                          SizedBox(width: 3,),
                          getTextWidget((isCm)?"Cm":"Ft", subTextColor, TextAlign.end, FontWeight.w600,
                          ...
                          Visibility(
                            visible: (!isCm),
                            child: getTextWidget("In", subTextColor, TextAlign.end, FontWeight.w600,
                                getScreenPercentSize(context, 2)),
                          ),
                        ],
                      ),
  ...
  getTab1( bool isRight,String s,bool isSelect,Function function) {
    ...
    return InkWell(
      ...
      child: Container(
        ...
        height: tabHeight,
        decoration: BoxDecoration(
            border: Border.all(color: (isSelect)?primaryColor:subTextColor.withOpacity(0.1), width: getPercentSize(tabHeight, 3)),
        ...
        child: Center(
          child: getTextWidget(s, (isSelect)?primaryColor:subTextColor, TextAlign.center, FontWeight.w600,
          getPercentSize(tabWidth, 16)),
        ),
      ),
    );
  }
                      ...
                      child: Row(
                        ...
                        children: [
                          IntrinsicWidth(
                            ...
                            child:    getTextField(new TextEditingController(text: (isKg)?kg.toString():lbs.toString())),
                          ),
                          SizedBox(width: 3,),
                          getTextWidget((isKg)?"Kg":"lb", subTextColor, TextAlign.end, FontWeight.w600,
                              getScreenPercentSize(context, 2)),
